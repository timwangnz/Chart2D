...
public class XMLWriter {
    ...
    /**
     * Called to write one IndexableDocument. Will be called by
     * CrawlableFactory.start().
     *
     * @param document
     */
    ...
    /**
     * Flushes IndexableDocument batch, and calls super.flush() This method is
     * not thread safe (batch could be written multiple times).
     */
    public void flush()
            throws IOException {
        if (!mHeaderWritten) {
        ...
        for (Iterator<AttributeDefinition> iter = fields.iterator(); iter.hasNext();) {
            ...
            if (field.isStored() && fieldValue != null) {
                ...
                if (fieldValue instanceof Object[]) {
                    ...
                    valueArray = new Object[]{fieldValue};
                }
