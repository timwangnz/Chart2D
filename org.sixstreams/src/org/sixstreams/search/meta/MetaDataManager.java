...
public class MetaDataManager
{
	 ...
	 * 
	 * @param type
	 *            - the type of object (SearchableObject, etc).
	 * @param obj
	 *            - the object
	 */
	...
	public static SearchEngine getSearchEngine(long engineId)
	{
		...
		{
			connectorClass = getProperty(ENGINE_DEFAULT_CLASS, SearchEngineImpl.class.getName());
		}
