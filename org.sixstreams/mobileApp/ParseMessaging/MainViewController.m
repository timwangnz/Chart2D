...
- (void)receivedTranscript:(SSConversation *)transcript
{
...
- (void)updateTranscript:(SSConversation *)transcript
{
...
- (void)insertTranscript:(SSConversation *)transcript
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SSConversation *transcript = [self.transcripts objectAtIndex:indexPath.row];
...
// Action method when pressing the "browse" (search icon).  It presents the MCBrowserViewController:
//a framework UI which enables users to invite and connect to other peers with the same room name (aka service type).
