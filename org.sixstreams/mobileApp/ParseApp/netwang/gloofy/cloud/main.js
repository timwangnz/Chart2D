...
Parse.Cloud.afterDelete("org_sixstreams_user_Group", function(request)
                        {
                        var groupId = request.object.id;
                        query = new Parse.Query('org_sixstreams_user_Membership');
                        
                        query.equalTo("groupId", groupId);
                        
                        console.log("Deleting membership for " + groupId);
                        ...
                        query.find({
                                   ...
                                   memberships[i].destroy({success: function (user) {
                                   ...
                                   error: function(error) {
                                   console.error("Error finding memberships " + error.toJSON());
                                   }
                                   });
                        }
                        );
